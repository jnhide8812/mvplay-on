...
<header>
	<div class="top_content">
		<div class="logo_area">
			<a href="/main"><img src="resources/icon/logo_m.png"></a>
		</div>
		<form action="searchc.do" class="sc">
			<div class="search">
				<input type="text" placeholder="작품명을 입력해주세요" name="searchText"
					class="main_search"> <input type="button"
					onclick="location.href='search.do'" class="search_icon">
			</div>
		</form>
