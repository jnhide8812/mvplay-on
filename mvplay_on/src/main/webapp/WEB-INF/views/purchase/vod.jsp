						...
						<!--div 좌측poster도 넣어야됨...  -->
                          ...
                          <div class="form_section">     
                             <div class="form_section_content"><!--  개봉일? -->
                                <fmt:formatDate value='${movieInfo.movieDate}' pattern='yyyy-MM-dd'/>
                             </div>
                          </div>                                                         
                          <div class="form_section">
                             <div class="form_section_content">
                              <div>${movieInfo.cate1}</div>
                              
                            </div> 
                           <div>
                                <div>${movieInfo.cate2}</div>
                             </div>
                          </div>               
