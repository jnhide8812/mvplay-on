...
<div id="container">
	<div id="l_wrap">
		<div class="login_main">
			<ul>
				<li class="login_top">
					<div class="l_title"><h1>로그인</h1></div>
					<div class="find">
						<a href="findPW.do">비밀번호 잊어버리셨나요?</a>
					</div>
				</li>
				<li>
					<input type="text" placeholder="이메일을 입력해주세요" name="email" class="email">
				</li>
				<li>
					<input type="password" placeholder="비밀번호를 입력해주세요" name="upw" class="pw">
				</li>
				<li>
					<input type="submit" value="로그인" class="logb">
				</li>
			</ul>
		</div>
		<div class="s_footer">
